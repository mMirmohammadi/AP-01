...
public class SimpleGameCard extends SimpleCard {

  public static interface PosFunction {
    void put(BeingDna dna, int i, int j);
  }
  ...
  public SimpleGameCard(PosFunction onPut, BeingDna dna, double x, double y, double size) {
